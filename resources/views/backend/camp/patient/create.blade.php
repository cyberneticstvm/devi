        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <h5>Create Camp Patient</h5><span>Create New Camp Patient</span>
                    </div>
                    <div class="card-body">
                        <div class="text-center"><h5 class="txt-primary">{{ $camp->name }} - {{ $camp->camp_id }}</h5></div>
                        <div class="card-wrapper mt-3">
                            <form class="row g-3" method="post" action="{{ route('camp.patient.save') }}">
                                @csrf
                                ...
                                <div class="col-md-12 table-responsive">
                                    ...
                                    <table class="table table-bordered mt-3">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>RE</td>
                                                <td><input type="text" name="re_vb" class="form-control form-control-sm text-center" maxlength="6" placeholder="VB" value="{{ old('re_vb') }}"></td>
                                            ...
                                            <tr>
                                                <td>LE</td>
                                                <td><input type="text" name="le_vb" class="form-control form-control-sm text-center" maxlength="6" placeholder="VB" value="{{ old('le_vb') }}"></td>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" id="further_investigation_advised" type="checkbox" role="switch" name="further_investigation_advised" value="1">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label">Glasses Advised?</label>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" id="galsses_advised" type="checkbox" role="switch" name="galsses_advised" value="1">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label">Yearly Eye Test Advised?</label>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" id="yearly_eye_test_advised" type="checkbox" role="switch" name="yearly_eye_test_advised" value="1">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <label class="form-label">Surgery Advised?</label>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" id="surgery_advised" type="checkbox" role="switch" name="surgery_advised" value="1">
                                    </div>
                                </div>
