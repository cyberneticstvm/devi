        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center"><h5 class="txt-primary">{{ $campatient->camp->name }} - {{ $campatient->camp->camp_id }}</h5></div>
                                ...
                                <div class="col-md-12 table-responsive">
                                    ...
                                    <table class="table table-bordered mt-3">
                                        <thead class="text-center">
                                            <tr><th>EYE</th><th>VB</th><th>SPH</th><th>CYL</th><th>AXIS</th><th>ADD</th><th>VA</th></tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td>RE</td>
                                                <td><input type="text" name="re_vb" class="form-control form-control-sm text-center" maxlength="6" placeholder="VB" value="{{ $campatient->vision->re_vb ?? old('re_vb') }}"></td>
                                                <td><input type="text" name="re_sph" class="form-control form-control-sm text-center" maxlength="6" placeholder="SPH" value="{{ $campatient->vision->re_sph ?? old('re_sph') }}"></td>
                                                <td><input type="text" name="re_cyl" class="form-control form-control-sm text-center" maxlength="6" placeholder="CYL" value="{{ $campatient->vision->re_cyl ?? old('re_cyl') }}"></td>
                                                <td><input type="text" name="re_axis" class="form-control form-control-sm text-center" maxlength="6" placeholder="AXIS" value="{{ $campatient->vision->re_axis ?? old('re_axis') }}"></td>
                                                <td><input type="text" name="re_add" class="form-control form-control-sm text-center" maxlength="6" placeholder="ADD" value="{{ $campatient->vision->re_add ?? old('re_add') }}"></td>
                                                <td><input type="text" name="re_va" class="form-control form-control-sm text-center" maxlength="6" placeholder="VA" value="{{ $campatient->vision->re_va ?? old('re_va') }}"></td>                                                
                                            </tr>
                                            <tr>
                                                <td>LE</td>
                                                <td><input type="text" name="le_vb" class="form-control form-control-sm text-center" maxlength="6" placeholder="VB" value="{{ $campatient->vision->le_vb ?? old('le_vb') }}"></td>
                                                <td><input type="text" name="le_sph" class="form-control form-control-sm text-center" maxlength="6" placeholder="SPH" value="{{ $campatient->vision->le_sph ?? old('le_sph') }}"></td>
                                                <td><input type="text" name="le_cyl" class="form-control form-control-sm text-center" maxlength="6" placeholder="CYL" value="{{ $campatient->vision->le_cyl ?? old('le_cyl') }}"></td>
                                                <td><input type="text" name="le_axis" class="form-control form-control-sm text-center" maxlength="6" placeholder="AXIS" value="{{ $campatient->vision->le_axis ?? old('le_axis') }}"></td>
                                                <td><input type="text" name="le_add" class="form-control form-control-sm text-center" maxlength="6" placeholder="ADD" value="{{ $campatient->vision->le_add ?? old('le_add') }}"></td>
                                                <td><input type="text" name="le_va" class="form-control form-control-sm text-center" maxlength="6" placeholder="VA" value="{{ $campatient->vision->le_va ?? old('le_va') }}"></td>                                                
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>                                                               
