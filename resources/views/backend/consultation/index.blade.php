                            ...
                            <table class="display" id="dataTable" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><a href="{{ route('store.order.create', encrypt($con->id)) }}">Order</a></td>
                                        <td class="text-center"><a href="{{ route('pharmacy.order.create', encrypt($con->id)) }}">Order</a></td>
                                        <td>{!! $con->status() !!}</td>
