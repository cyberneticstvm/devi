...
<div class="row">
    ...
    <div class="col">
        <table class="table bordered" width="100%" cellspacing="0" cellpadding="0">
            <thead>
                <tr><th width="15%">SL No</th><th width="65%">Particulars</th><th>Amount</th></tr>
            </thead>
            <tbody>
                <tr>
                    <td>1</td><td>Registration Fee</td><td class="text-right">{{ number_format($consultation->patient->registration_fee, 2) }}</td>
                </tr>
                <tr>
                    <td>2</td><td>Consultation Fee</td><td class="text-right">{{ number_format($consultation->fee, 2) }}</td>
                </tr>
            </tbody>
            <tfoot>
                <tr><td colspan="2"></td><td class="text-right fw-bold">{{ number_format($consultation->fee + $consultation->patient->registration_fee, 2) }}</td></tr>
            </tfoot>
        </table>
    </div>
</div>
