            ...
            <div class="row">
                ...
                <div class="col-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">Pharmcy Product</li>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Create Product</h5><span>Create New Pharmacy Product</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('product.pharmacy.save') }}">
                                @csrf
                                <div class="col-md-4">
                                ...
                                <div class="col-md-3">
                                    ...
                                    {{ html()->select($name = 'type_id', $value = $ptypes->pluck('name', 'id'), old('type_id'))->class('form-control select2')->placeholder('Select') }}
                                    @error('type_id')
