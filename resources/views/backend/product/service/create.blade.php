            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Create Product</h5><span>Create New Service Product</span>
                    </div>
                    <div class="card-body">
                        <div class="card-wrapper">
                            <form class="row g-3" method="post" action="{{ route('product.service.save') }}">
                                @csrf
                                <div class="col-md-4">
                                ...
                                <div class="col-md-2">
                                    ...
                                    {{ html()->text($name = 'code', $value = productcode('service'))->class('form-control')->placeholder('Product Code') }}
                                    @error('code')
