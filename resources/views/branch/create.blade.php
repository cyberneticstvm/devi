...
<div class="layout-page">
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <div class="row">
            <div class="col">
                <h4 class="py-3 breadcrumb-wrapper mb-4"><span class="text-muted fw-light">Branch Management/</span> Create Branch</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-xxl">
                        ...
                        <form method="post" action="{{ route('branch.create') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    {!! Form::text('code', null, array('placeholder' => 'Branch Code','class' => 'form-control')) !!}
                                    @error('code')
                                ...
                                <div class="col-md-5 mb-3">
                                    ...
                                    {!! Form::text('address', null, array('placeholder' => 'Branch Address','class' => 'form-control')) !!}
                                    @error('address')
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    {!! Form::number('invoice_starts_with', null, array('placeholder' => '0','class' => 'form-control')) !!}
                                </div>
                                <div class="col-md-2 mb-3">
                                    <label class="form-label req">Credit Limit </label>
                                    {!! Form::number('credit_limit', null, array('placeholder' => '0.00','class' => 'form-control', 'step' => 'any')) !!}
                                    @error('credit_limit')
