                        ...
                        <form method="post" action="{{ route('subcategory.update', $subcategory->id) }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3 mb-3">
                                    ...
                                    {!! Form::text('name', $subcategory->name, array('placeholder' => 'Subcategory Name','class' => 'form-control')) !!}
                                    @error('name')
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    {!! Form::select('category_id', $categories, $subcategory->category_id, array('placeholder' => 'Category Name','class' => 'form-control select2', 'data-placeholder' => 'Select Category')) !!}
                                    @error('category_id')
